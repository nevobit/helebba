...
import type { Catalog, CatalogOrder, OffsetPaginatedResult } from '@hlb/contracts';
...
export const catalogOrders = async (id: string) => (await api.get<CatalogOrder[]>(`/catalogs/${id}/orders`)).data;
